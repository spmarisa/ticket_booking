...
ActiveRecord::Schema[7.0].define(version: 2022_05_30_100424) do
  ...
  create_table "train_coaches", force: :cascade do |t|
    t.integer "type"
  ...
  create_table "train_journeys", force: :cascade do |t|
    t.integer "train_id"
  ...
  create_table "train_travel_paths", force: :cascade do |t|
    t.integer "train_id"
    t.string "source"
